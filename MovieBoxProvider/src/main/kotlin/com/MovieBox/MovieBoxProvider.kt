...
class MovieBoxProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "1|1;country=India;classify=Hindi dub;genre=Action;short=Latest" to "Action (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Adventure;short=Latest" to "Adventure (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Comedy;short=Latest" to "Comedy (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Crime;short=Latest" to "Crime (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Drama;short=Latest" to "Drama (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Family;short=Latest" to "Family (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Horror;short=Latest" to "Horror (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Sci-Fi;short=Latest" to "Sci-Fi (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=Thriller;short=Latest" to "Thriller (Movies)",
        "1|1;country=India;classify=Hindi dub;genre=War;short=Latest" to "War (Movies)",
        "1|2;country=India" to "Indian (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Action;short=Latest" to "Action (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Adventure;short=Latest" to "Adventure (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Comedy;short=Latest" to "Comedy (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Crime;short=Latest" to "Crime (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Drama;short=Latest" to "Drama (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Family;short=Latest" to "Family (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Horror;short=Latest" to "Horror (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Romance;short=Latest" to "Romance (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Sci-Fi;short=Latest" to "Sci-Fi (Series)",
        "1|2;country=India;classify=Hindi dub;genre=Thriller;short=Latest" to "Thriller (Series)",
        "1|2;country=India;classify=Hindi dub;genre=War;short=Latest" to "War (Series)",
