...
@CloudstreamPlugin
open class XtronPlayPlugin: Plugin() {
    override fun load(context: Context) {
        ...
        val sharedPref = context.getSharedPreferences("XtronPlayStudios", Context.MODE_PRIVATE)
        ...
        openSettings = {
            val frag = XtronPlaySettings(this, sharedPref, studioOptions)
            frag.show(activity.supportFragmentManager, "XtronPlaySettings")
        }
    }
