...
// Studio toggle entry for XtronPlay
data class StudioOption(val key: String, val label: String, val cookieValue: String)

class XtronPlaySettings(
    private val plugin: XtronPlayPlugin,
    ...
    private fun getDrawable(name: String): Drawable? {
        val id = plugin.resources?.getIdentifier(name, "drawable", "com.XtronPlay")
    ...
    private fun getString(name: String): String? {
        val id = plugin.resources?.getIdentifier(name, "string", "com.XtronPlay")
    ...
    private fun <T : View> View.findViewByName(name: String): T? {
        val id = plugin.resources?.getIdentifier(name, "id", "com.XtronPlay")
    ...
    override fun onCreateView(
        ...
        val layoutId = plugin.resources?.getIdentifier("settings", "layout", "com.XtronPlay")
        return layoutId?.let {
    ...
    private fun getStudioRow(option: StudioOption): RelativeLayout {
        val relativeLayout = RelativeLayout(this@XtronPlaySettings.requireContext()).apply {
        ...
        val checkBox = CheckBox(this@XtronPlaySettings.requireContext()).apply {
        ...
        val textView = TextView(this@XtronPlaySettings.requireContext()).apply {
            id = View.generateViewId()
            text = option.label
            textSize = 16f
            layoutParams = RelativeLayout.LayoutParams(
